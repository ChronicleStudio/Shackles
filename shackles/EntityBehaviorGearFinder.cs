...
namespace shackles
{
    internal class EntityBehaviorGearFinder : EntityBehavior
    {
        ...
        public EntityBehaviorGearFinder(Entity entity)
            : base(entity)
        {
            Prison = entity?.Api.ModLoader.GetModSystem<ShackleGearModSystem>().Prison;
            Tracker = entity?.Api.ModLoader.GetModSystem<ShackleGearTrackerModSystem>();
        }
