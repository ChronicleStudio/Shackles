...
namespace Shackles.ShackleSystems
{
	public class PrisonController
	{
		...
		private ShacklesModSystem shackleGear;

		public PrisonController(ICoreServerAPI sapi)
		{
			this.sapi = sapi;
			tracker = sapi.ModLoader.GetModSystem<ShackleTrackerModSystem>();
			shackleGear = sapi.ModLoader.GetModSystem<ShacklesModSystem>();
		}
		...
		public bool TryImprisonPlayer(IServerPlayer prisoner, IPlayer killer, ItemSlot slot)
		{
			...
			ShackleTrackerModSystem modSystem = sapi.ModLoader.GetModSystem<ShackleTrackerModSystem>();
			...
			ShackleEvents.RegisterPearlUpdate(prisoner);
