...
namespace shackles
{
    internal class ItemShackle : Item
    {
        ...
        public PrisonController Prsn => api.ModLoader.GetModSystem<ShackleGearModSystem>().Prison;

        public ShackleGearTrackerModSystem Tracker => api.ModLoader.GetModSystem<ShackleGearTrackerModSystem>();

        internal ShacklesServerConfig Config => api.ModLoader.GetModSystem<ShacklesModSystem>().config;
